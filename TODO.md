...
- [x] Re factor He5Helper and write all tests
- [x] Re Factor TiFHelper and write all tests
...
- [ ] Write out a utility function to convert the DNs in Prisma to usable values and document the process.
