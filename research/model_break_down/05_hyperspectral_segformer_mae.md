...
### `hyperspectral_segformer_mae` — **Indradhanu** (इंद्रधनु) — Hyperspectral SegFormer MAE

> *rainbow (literally 'Indra's bow').* 165 spectral bands — the full spectrum, with a learnable spectral compressor at the front.

- **Current pick**: `hyperspectral_segformer_mae_v0.2.0_epoch200.pt` (val loss `0.04349`, `5,507,354` params)
- **Diagram input shape**: see SVG below; built via `model_break_down/render_architectures.py`.
- **Normalization**: baked into `forward` via `register_buffer`, shape `[1, 165, 1, 1]`.

![hyperspectral_segformer_mae block diagram](diagrams/hyperspectral_segformer_mae.svg)
...
===========================================================================================================================================================
HyperspectralSegFormerMAE                               [1, 165, 128, 128]        [1, 165, 128, 128]        --                        True
├─SpectralCompressor: 1-1                               [1, 165, 128, 128]        [1, 32, 128, 128]         --                        True
│    └─Conv2d: 2-1                                      [1, 165, 128, 128]        [1, 32, 128, 128]         5,312                     True
│    └─BatchNorm2d: 2-2                                 [1, 32, 128, 128]         [1, 32, 128, 128]         64                        True
├─SegFormerEncoder: 1-2                                 [1, 32, 128, 128]         [1, 32, 32, 32]           --                        True
│    └─ModuleList: 2-12                                 --                        --                        (recursive)               True
│    │    └─OverlapPatchEmbedding: 3-1                  [1, 32, 128, 128]         [1, 1024, 32]             16,480                    True
│    └─ModuleList: 2-13                                 --                        --                        (recursive)               True
│    │    └─ModuleList: 3-2                             --                        --                        159,232                   True
│    └─ModuleList: 2-14                                 --                        --                        (recursive)               True
│    │    └─LayerNorm: 3-3                              [1, 1024, 32]             [1, 1024, 32]             64                        True
│    └─ModuleList: 2-12                                 --                        --                        (recursive)               True
│    │    └─OverlapPatchEmbedding: 3-4                  [1, 32, 32, 32]           [1, 256, 64]              18,624                    True
│    └─ModuleList: 2-13                                 --                        --                        (recursive)               True
│    │    └─ModuleList: 3-5                             --                        --                        236,544                   True
│    └─ModuleList: 2-14                                 --                        --                        (recursive)               True
│    │    └─LayerNorm: 3-6                              [1, 256, 64]              [1, 256, 64]              128                       True
│    └─ModuleList: 2-12                                 --                        --                        (recursive)               True
│    │    └─OverlapPatchEmbedding: 3-7                  [1, 64, 16, 16]           [1, 64, 160]              92,640                    True
│    └─ModuleList: 2-13                                 --                        --                        (recursive)               True
│    │    └─ModuleList: 3-8                             --                        --                        837,120                   True
│    └─ModuleList: 2-14                                 --                        --                        (recursive)               True
│    │    └─LayerNorm: 3-9                              [1, 64, 160]              [1, 64, 160]              320                       True
│    └─ModuleList: 2-12                                 --                        --                        (recursive)               True
│    │    └─OverlapPatchEmbedding: 3-10                 [1, 160, 8, 8]            [1, 16, 256]              369,408                   True
│    └─ModuleList: 2-13                                 --                        --                        (recursive)               True
│    │    └─ModuleList: 3-11                            --                        --                        1,600,000                 True
│    └─ModuleList: 2-14                                 --                        --                        (recursive)               True
│    │    └─LayerNorm: 3-12                             [1, 16, 256]              [1, 16, 256]              512                       True
├─SegFormerDecoder: 1-3                                 [1, 32, 32, 32]           [1, 32, 128, 128]         --                        True
│    └─ModuleList: 2-15                                 --                        --                        --                        True
│    │    └─Conv2d: 3-13                                [1, 32, 32, 32]           [1, 256, 32, 32]          8,448                     True
│    │    └─Conv2d: 3-14                                [1, 64, 16, 16]           [1, 256, 16, 16]          16,640                    True
│    │    └─Conv2d: 3-15                                [1, 160, 8, 8]            [1, 256, 8, 8]            41,216                    True
│    │    └─Conv2d: 3-16                                [1, 256, 4, 4]            [1, 256, 4, 4]            65,792                    True
│    └─Conv2d: 2-16                                     [1, 1024, 32, 32]         [1, 256, 32, 32]          262,400                   True
│    └─GELU: 2-17                                       [1, 256, 32, 32]          [1, 256, 32, 32]          --                        --
│    └─Sequential: 2-18                                 [1, 256, 32, 32]          [1, 512, 32, 32]          --                        True
│    │    └─Conv2d: 3-17                                [1, 256, 32, 32]          [1, 256, 32, 32]          590,080                   True
│    │    └─GELU: 3-18                                  [1, 256, 32, 32]          [1, 256, 32, 32]          --                        --
│    │    └─Conv2d: 3-19                                [1, 256, 32, 32]          [1, 512, 32, 32]          1,180,160                 True
├─SpectralDecompressor: 1-4                             [1, 32, 128, 128]         [1, 165, 128, 128]        --                        True
│    └─Conv2d: 2-19                                     [1, 32, 128, 128]         [1, 165, 128, 128]        5,445                     True
===========================================================================================================================================================
Total params: 5,506,629
Trainable params: 5,506,629
Non-trainable params: 0
Total mult-adds (Units.GIGABYTES): 2.32
===========================================================================================================================================================
Input size (MB): 10.81
Forward/backward pass size (MB): 56.31
