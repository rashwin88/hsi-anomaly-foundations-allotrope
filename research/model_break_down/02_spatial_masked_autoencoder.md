...
### `spatial_masked_autoencoder` — **Antardhana** (अंतर्धान) — Spatial Masked Autoencoder — MSE (thermal)

> *concealment, vanishing.* Random pixels are concealed during training; the model must bring back what was hidden. MSE-loss variant.

- **Current pick**: `spatial_masked_autoencoder_v0.1.0_epoch121.pt` (val loss `17.28919`, `265,480` params)
...
![spatial_masked_autoencoder block diagram](diagrams/spatial_masked_autoencoder.svg)
...
======================================================================================================================================================
SpatialAutoencoder                                 [1, 1, 128, 128]          [1, 1, 128, 128]          --                        True
├─SpatialEncoder: 1-1                              [1, 1, 128, 128]          [1, 128, 32, 32]          --                        True
│    └─Sequential: 2-1                             [1, 1, 128, 128]          [1, 128, 32, 32]          --                        True
│    │    └─SpatialEncoderBlock: 3-1               [1, 1, 128, 128]          [1, 64, 64, 64]           1,216                     True
...
Total mult-adds (Units.MEGABYTES): 692.73
======================================================================================================================================================
Input size (MB): 0.13
...
### `spatial_masked_autoencoder_l1` — **Tirohita** (तिरोहित) — Spatial Masked Autoencoder — L1 (thermal)

> *the hidden one.* Sibling to Antardhana — same concealment game, gentler L1 loss.

- **Current pick**: `spatial_masked_autoencoder_l1_v0.4.0_epoch77.pt` (val loss `1.79195`, `330,314` params)
- **Diagram input shape**: see SVG below; built via `model_break_down/render_architectures.py`.
- **Normalization**: baked into `forward` via `register_buffer` (μ=24.5756, σ=13.5744); caller passes raw, gets raw back.

![spatial_masked_autoencoder_l1 block diagram](diagrams/spatial_masked_autoencoder_l1.svg)
...
======================================================================================================================================================
SpatialAutoencoder                                 [1, 1, 128, 128]          [1, 1, 128, 128]          --                        True
├─SpatialEncoder: 1-1                              [1, 1, 128, 128]          [1, 128, 16, 16]          --                        True
│    └─Sequential: 2-1                             [1, 1, 128, 128]          [1, 128, 16, 16]          --                        True
│    │    └─SpatialEncoderBlock: 3-1               [1, 1, 128, 128]          [1, 32, 64, 64]           608                       True
│    │    └─SpatialEncoderBlock: 3-2               [1, 32, 64, 64]           [1, 64, 32, 32]           32,960                    True
│    │    └─SpatialEncoderBlock: 3-3               [1, 64, 32, 32]           [1, 128, 16, 16]          131,456                   True
├─SpatialDecoder: 1-2                              [1, 128, 16, 16]          [1, 1, 128, 128]          --                        True
│    └─Sequential: 2-2                             [1, 128, 16, 16]          [1, 1, 128, 128]          --                        True
│    │    └─SpatialDecoderBlock: 3-4               [1, 128, 16, 16]          [1, 64, 32, 32]           131,264                   True
│    │    └─SpatialDecoderBlock: 3-5               [1, 64, 32, 32]           [1, 32, 64, 64]           32,864                    True
│    │    └─SpatialDecoderBlock: 3-6               [1, 32, 64, 64]           [1, 1, 128, 128]          513                       True
======================================================================================================================================================
Total params: 329,665
Trainable params: 329,665
Non-trainable params: 0
Total mult-adds (Units.MEGABYTES): 346.47
======================================================================================================================================================
Input size (MB): 0.13
