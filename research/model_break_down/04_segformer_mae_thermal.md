...
### `segformer_mae` — **Chakshu** (चक्षु) — SegFormer MAE — thermal

> *eye, faculty of sight.* 4-stage hierarchical transformer — multi-scale attention is sight across resolutions.

- **Current pick**: `segformer_mae_v0.8.0_epoch495.pt` (val loss `0.2565`, `406,500` params)
...
![segformer_mae block diagram](diagrams/segformer_mae.svg)
...
===========================================================================================================================================================
SegFormerMAE                                            [1, 1, 256, 256]          [1, 1, 256, 256]          --                        True
├─SegFormerEncoder: 1-1                                 [1, 1, 256, 256]          [1, 16, 64, 64]           --                        True
│    └─ModuleList: 2-10                                 --                        --                        (recursive)               True
│    │    └─OverlapPatchEmbedding: 3-1                  [1, 1, 256, 256]          [1, 4096, 16]             304                       True
│    └─ModuleList: 2-11                                 --                        --                        (recursive)               True
│    │    └─ModuleList: 3-2                             --                        --                        18,976                    True
│    └─ModuleList: 2-12                                 --                        --                        (recursive)               True
│    │    └─LayerNorm: 3-3                              [1, 4096, 16]             [1, 4096, 16]             32                        True
│    └─ModuleList: 2-10                                 --                        --                        (recursive)               True
│    │    └─OverlapPatchEmbedding: 3-4                  [1, 16, 64, 64]           [1, 1024, 32]             4,704                     True
│    └─ModuleList: 2-11                                 --                        --                        (recursive)               True
│    │    └─ModuleList: 3-5                             --                        --                        25,664                    True
│    └─ModuleList: 2-12                                 --                        --                        (recursive)               True
│    │    └─LayerNorm: 3-6                              [1, 1024, 32]             [1, 1024, 32]             64                        True
│    └─ModuleList: 2-10                                 --                        --                        (recursive)               True
│    │    └─OverlapPatchEmbedding: 3-7                  [1, 32, 32, 32]           [1, 256, 64]              18,624                    True
│    └─ModuleList: 2-11                                 --                        --                        (recursive)               True
│    │    └─ModuleList: 3-8                             --                        --                        51,328                    True
│    └─ModuleList: 2-12                                 --                        --                        (recursive)               True
│    │    └─LayerNorm: 3-9                              [1, 256, 64]              [1, 256, 64]              128                       True
│    └─ModuleList: 2-10                                 --                        --                        (recursive)               True
│    │    └─OverlapPatchEmbedding: 3-10                 [1, 64, 16, 16]           [1, 64, 96]               55,584                    True
│    └─ModuleList: 2-11                                 --                        --                        (recursive)               True
│    │    └─ModuleList: 3-11                            --                        --                        76,704                    True
│    └─ModuleList: 2-12                                 --                        --                        (recursive)               True
│    │    └─LayerNorm: 3-12                             [1, 64, 96]               [1, 64, 96]               192                       True
├─SegFormerDecoder: 1-2                                 [1, 16, 64, 64]           [1, 1, 256, 256]          --                        True
│    └─ModuleList: 2-13                                 --                        --                        --                        True
│    │    └─Conv2d: 3-13                                [1, 16, 64, 64]           [1, 96, 64, 64]           1,632                     True
│    │    └─Conv2d: 3-14                                [1, 32, 32, 32]           [1, 96, 32, 32]           3,168                     True
│    │    └─Conv2d: 3-15                                [1, 64, 16, 16]           [1, 96, 16, 16]           6,240                     True
│    │    └─Conv2d: 3-16                                [1, 96, 8, 8]             [1, 96, 8, 8]             9,312                     True
│    └─Conv2d: 2-14                                     [1, 384, 64, 64]          [1, 96, 64, 64]           36,960                    True
│    └─GELU: 2-15                                       [1, 96, 64, 64]           [1, 96, 64, 64]           --                        --
│    └─Sequential: 2-16                                 [1, 96, 64, 64]           [1, 16, 64, 64]           --                        True
│    │    └─Conv2d: 3-17                                [1, 96, 64, 64]           [1, 96, 64, 64]           83,040                    True
│    │    └─GELU: 3-18                                  [1, 96, 64, 64]           [1, 96, 64, 64]           --                        --
│    │    └─Conv2d: 3-19                                [1, 96, 64, 64]           [1, 16, 64, 64]           13,840                    True
===========================================================================================================================================================
Total params: 406,496
Trainable params: 406,496
Non-trainable params: 0
Total mult-adds (Units.MEGABYTES): 580.17
===========================================================================================================================================================
Input size (MB): 0.26
Forward/backward pass size (MB): 22.92
Params size (MB): 1.63
Estimated Total Size (MB): 24.81
===========================================================================================================================================================
```
