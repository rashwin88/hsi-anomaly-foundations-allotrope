"""
rx-had-exp4: Destripe → GlobalRX with detailed per-scene stats.

Pipeline: HE5 → PrismaDatasetBuilder → CombinedDestriper (fixed MM bug)
...
logger = logging.getLogger("rx-had-exp4")
logging.getLogger("rx-had-exp4").setLevel(logging.INFO)
